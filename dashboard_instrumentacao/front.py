...
def _main_ ():#----- 1. criação contexto front ------ #
    ...
    with dpg.theme() as tema_claro:
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_color(dpg.mvPlotCol_PlotBg, (255, 255, 255, 255))
        ...
        with dpg.group(horizontal=True):
            ...
            with dpg.group(horizontal=True):
                with dpg.group(horizontal=False):
                    ...
                    dpg.add_input_int(default_value=0, width=90, tag="input_outlier", min_value=0)
                    dpg.add_spacer(height=20)
                    dpg.add_button(label="Remover Outliers", callback=process)
